...
import com.infinity.infoway.bmu.fragment.DaysFragment;
import com.infinity.infoway.bmu.R;
import com.infinity.infoway.bmu.app.DataStorage;
import com.infinity.infoway.bmu.model.Lecturedetail;
           ...
           // progressDialog.setMessage("Please Wait");
            ...
            call.enqueue(new Callback<ArrayList<TimeTableResponse>>()
            {
                ...
                public void onResponse(Call<ArrayList<TimeTableResponse>> call, Response<ArrayList<TimeTableResponse>> response) {
                    ...
                    System.out.println("TIME TABLE STUDENT  "+call.request()+"");

...
/**
 * Created by user01 on 12/8/2017.
 */

public class Expan_news_adapter extends BaseExpandableListAdapter
{
    ...
    public Expan_news_adapter(Context context, List<String> listDataHeader, List<String> listDataEarlyby, List<String> listDataLateby,

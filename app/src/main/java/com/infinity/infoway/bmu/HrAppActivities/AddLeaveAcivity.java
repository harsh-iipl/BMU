package com.infinity.infoway.bmu.HrAppActivities;
...
import com.infinity.infoway.bmu.CommonCls.CustomBoldTextView;
import com.infinity.infoway.bmu.CommonCls.CustomButton;
import com.infinity.infoway.bmu.CommonCls.CustomTextView;
import com.infinity.infoway.bmu.CommonCls.DialogUtils;
import com.infinity.infoway.bmu.CommonCls.MySharedPrefereces;
import com.infinity.infoway.bmu.HrAppAPI.URLS;
import com.infinity.infoway.bmu.HrAppAdapter.SpinnerSimpleAdapter;
import com.infinity.infoway.bmu.HrAppPojo.AddMissPunchPojo;
import com.infinity.infoway.bmu.HrAppPojo.CancelLeaveMailPojo;
import com.infinity.infoway.bmu.HrAppPojo.EmpLeaveBalancePojo;
import com.infinity.infoway.bmu.HrAppPojo.InOutTimePojo;
import com.infinity.infoway.bmu.HrAppPojo.LeaveDaysPojo;
import com.infinity.infoway.bmu.HrAppPojo.LeaveDetailPojo;
import com.infinity.infoway.bmu.HrAppPojo.LeaveTypePojo;
import com.infinity.infoway.bmu.HrAppPojo.NotesPojo;
import com.infinity.infoway.bmu.HrAppPojo.ReasonPojo;
...
public class AddLeaveAcivity extends AppCompatActivity implements View.OnClickListener {
    ...
    LinearLayout lltodate, ll_submit_cancel, ll_cancel_approve_leave;
    EditText edtday;
    LinearLayout llday;
    EditText edtremark;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_leave_acivity);
...
//                DialogUtils.hideProgressDialog();
    ...
    public boolean isEmpty() {
        ...
        if (edtempname.getText().toString().trim().contentEquals("") || edtempname.getText().toString().trim().length() < 0) {
            ...
            return false;
        } else if (edtfromdate.getText().toString().contentEquals("") || edtfromdate.getText().toString().trim().length() < 0) {
            DialogUtils.Show_Toast(AddLeaveAcivity.this, "Enter From Date");

            return false;
        } else if (edttodate.getText().toString().contentEquals("") || edttodate.getText().toString().trim().length() < 0) {
            DialogUtils.Show_Toast(AddLeaveAcivity.this, "Enter To Date");

            return false;
        } else if (edtday.getText().toString().contentEquals("") || edtday.getText().toString().trim().length() < 0) {
            DialogUtils.Show_Toast(AddLeaveAcivity.this, "Enter Day");

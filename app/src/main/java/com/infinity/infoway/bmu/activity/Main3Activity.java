...
import com.infinity.infoway.bmu.HrAppPojo.LoginPojo;
import com.infinity.infoway.bmu.R;
import com.infinity.infoway.bmu.adapter.Pageradapter;
import com.infinity.infoway.bmu.app.DataStorage;
import com.infinity.infoway.bmu.app.Login_Master;
...
import com.infinity.infoway.bmu.rest.Api_Client;
                                    ...
                                    if (loginPojo.getData().get(0) != null)
                                    {
                                        if (loginPojo.getData().size() > 0)
                                        {
                                            if (loginPojo.getData().get(0).getStatus().contentEquals("1"))
                                            {
                                                ...
                                                Intent payroll_intent = new Intent(Main3Activity.this, com.infinity.infoway.bmu.HrAppActivities.MainActivity.class);
...
*/
            ...
            case R.id.nav_logout:
                ...
                break;
            case R.id.nav_share:
                String shareBody = "https://play.google.com/store/apps/details?id=com.infinity.infoway.bmu&hl=en";
                Intent sharingIntent = new Intent(Intent.ACTION_SEND);
                sharingIntent.setType("text/plain");
                sharingIntent.putExtra(Intent.EXTRA_SUBJECT, "BMU  App... ");

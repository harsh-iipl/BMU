...
import com.infinity.infoway.bmu.HrAppPojo.SalaryDwnloadPojo;
import com.infinity.infoway.bmu.HrAppPojo.SalarySlipPojo;
    ...
    private class DownloadFileFromURL extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... f_url) {
            ...
            try {
                ...
                conection.connect();
                File dir = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/Rku/"+"/Salary_slip/");
                dir.mkdirs();
                ...
                OutputStream output = new FileOutputStream("sdcard/Rku/"+"/Salary_slip/" + nameoffile);
        ...
        protected void onPostExecute(String file_url) {
            ...
            File file11 = new File(Environment.getExternalStorageDirectory().getAbsolutePath(), "Rku/"+"/Salary_slip/" + nameoffile);

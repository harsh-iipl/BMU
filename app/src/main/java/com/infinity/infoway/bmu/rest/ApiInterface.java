package com.infinity.infoway.bmu.rest;

import com.infinity.infoway.bmu.model.ChartDataRemainingAttendance;
import com.infinity.infoway.bmu.model.EmployeeAttendanceResponse;
import com.infinity.infoway.bmu.model.ExamDetailPOJO;
import com.infinity.infoway.bmu.model.ExamTTPojo;
import com.infinity.infoway.bmu.model.FcmResponse;
import com.infinity.infoway.bmu.model.Fee_Receipt_List;
import com.infinity.infoway.bmu.model.Fees;
import com.infinity.infoway.bmu.model.GetLatestVesionResponse;
import com.infinity.infoway.bmu.model.Holiday_next;
import com.infinity.infoway.bmu.model.LeaveResponse;
import com.infinity.infoway.bmu.model.LecturePlanEmployee;
import com.infinity.infoway.bmu.model.LessionResponse;
import com.infinity.infoway.bmu.model.LoginResponse;
import com.infinity.infoway.bmu.model.MultipartResponsePojo;
import com.infinity.infoway.bmu.model.NewsData;
import com.infinity.infoway.bmu.model.NotificationResponse;
import com.infinity.infoway.bmu.model.ProfileResponse;
import com.infinity.infoway.bmu.model.PunchData;
import com.infinity.infoway.bmu.model.RemainingAttResponse;
import com.infinity.infoway.bmu.model.Response_Activity;
import com.infinity.infoway.bmu.model.StudentAttendance;
import com.infinity.infoway.bmu.model.SyllabusResponse;
import com.infinity.infoway.bmu.model.TimeTableResponse;
import com.infinity.infoway.bmu.model.activity;
import com.infinity.infoway.bmu.model.assignment_response;
import com.infinity.infoway.bmu.model.birthdata;
import com.infinity.infoway.bmu.model.change_psw;
import com.infinity.infoway.bmu.model.collage_list;
import com.infinity.infoway.bmu.model.dir_stud_attendance;
import com.infinity.infoway.bmu.model.hod_list;
import com.infinity.infoway.bmu.model.homework_response;
import com.infinity.infoway.bmu.model.leave_data;
import com.infinity.infoway.bmu.model.new_lect_plan;
import com.infinity.infoway.bmu.model.pendingfeesmodel;
import com.infinity.infoway.bmu.model.result_response;
...
public interface ApiInterface
{
  ...
  /*  @GET("check_version_api")
    ...
    Call<MultipartResponsePojo> multipartImageUpload(@Part MultipartBody.Part postedFile, @Part("stud_id") RequestBody stud_id, @Part("ints_id") RequestBody ints_id, @Part("S_Key") RequestBody S_Key, @Part("report_title") RequestBody report_title, @Part("ints_description") RequestBody ints_description, @Part("ints_created_by") RequestBody ints_created_by, @Part("ints_created_ip") RequestBody ints_created_ip);

...
public class ExpandableListAdapter1 extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        TextView textView1 = (TextView)convertView.findViewById(R.id.child_item_2);
        textView1.setText(childText);

        TextView textView2 = (TextView)convertView.findViewById(R.id.child_item_3);
        textView2.setText(childText);

        TextView textView3 = (TextView)convertView.findViewById(R.id.child_item_4);

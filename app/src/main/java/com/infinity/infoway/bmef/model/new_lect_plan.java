...
//        }
        ...
        public static final Creator<new_lect_plan> CREATOR = new Creator<new_lect_plan>()
        {
            @Override
            public new_lect_plan createFromParcel(Parcel in)
            {
                return new new_lect_plan(in);
            }

            @Override
            public new_lect_plan[] newArray(int size)
            {
                return new new_lect_plan[size];
            }
        };
